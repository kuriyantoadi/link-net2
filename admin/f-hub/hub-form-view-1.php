...
<!-- awal -->
          ...
          <!--awal -->
          <form action="tambah-fo.php" method="post" name="input" onSubmit="return validasi()">
          <div class="col-md-10">
            <table class="table table-borderless">
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                      <input class="form-control" type="text" name="optical_light_tx" id="optical_light_tx">
                  </td>
                  <td>@RX</td>
                  <td>
                    <input class="form-control" type="text" name="optical_light_rx" id="optical_light_rx">
                  </td>
                </tr>
                <tr>
                  <td>Receiver No</td>
                  <td>
                      <input class="form-control" type="text" name="receiver_no" id="receiver_no">
                  </td>
                  <td>@Loss*</td>
                  <td>
                    <input class="form-control" type="text" name="receiver_loss" id="receiver_loss">
                  </td>
                </tr>
                <tr>
                  <td>Transmitter No</td>
                  <td>
                      <input class="form-control" type="text" name="transmitter_no" id="transmitter_no">
                  </td>
                  <td>%</td>
                  <td>
                    <input class="form-control" type="text" name="transmitter_persen" id="transmitter_persen">
                  </td>
                </tr>
                <tr>
                  <td>Signal @Transmitter Low</td>
                  <td>
                      <input class="form-control" type="text" name="signal_trans_low" id="signal_trans_low">
                  </td>
                  <td>High</td>
                  <td>
                    <input class="form-control" type="text" name="signal_trans_high" id="signal_trans_high">
                  </td>
                  <td>DL*</td>
                  <td>
                    <input class="form-control" type="text" name="signal_trans_dl" id="signal_trans_dl">
                  </td>
                <tr>
                  <td>CMTS No.</td>
                  <td>
                      <input class="form-control" type="text" name="cmts_no" id="cmts_no">
                  </td>
                  <td>Ds*</td>
                  <td>
                    <input class="form-control" type="text" name="cmts_ds" id="cmts_ds">
                  </td>
                  <td>Us*</td>
                  <td>
                    <input class="form-control" type="text" name="cmts_us" id="cmts_us">
                  </td>
                </tr>
                <tr>
                  <td>PIC</td>
